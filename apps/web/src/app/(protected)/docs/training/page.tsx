      ...
      <main className="flex-1 px-6 py-8 lg:px-12">
        ...
        <div className="mt-8 space-y-6">
          ...
          <Section id="record-to-report" title="5. Record-to-Report (บันทึก → รายงาน)" icon={FileText}>
            ...
            <div className="mt-2 rounded-lg border border-gray-200 bg-gray-50 p-4 font-mono text-xs dark:border-gray-700 dark:bg-gray-800">
              ...
              <div className="mt-2 space-y-1">
                ...
                <p className="mt-1 border-t border-gray-300 pt-1 dark:border-gray-600">กำไรขั้นต้น: (15,000.00)</p>
                ...
                <p className="mt-1 border-t border-gray-300 pt-1 font-bold dark:border-gray-600">กำไร(ขาดทุน)สุทธิ: (45,000.00)</p>
              </div>
            </div>
          </Section>
          ...
          <Section id="month-end" title="11. Month-End / Year-End Checklist" icon={CalendarCheck}>
            <h4 className="font-semibold text-gray-900 dark:text-gray-100">Month-End Close (13 steps)</h4>
            ...
            <h4 className="mt-6 font-semibold text-gray-900 dark:text-gray-100">Year-End Close</h4>
            <div className="mt-2 space-y-0">
