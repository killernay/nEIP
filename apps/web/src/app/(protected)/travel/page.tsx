            ...
            <tbody>
              {requests.map((r) => (
                <tr key={r.id} className="border-b border-[var(--color-border)] transition-colors hover:bg-[var(--color-accent)]/30">
                  ...
                  <td className="px-4 py-3 text-right"><MoneyDisplay amount={BigInt(r.estimatedCostSatang)} /></td>
                  <td className="px-4 py-3 text-right">{r.actualCostSatang !== null ? <MoneyDisplay amount={BigInt(r.actualCostSatang)} /> : '—'}</td>
